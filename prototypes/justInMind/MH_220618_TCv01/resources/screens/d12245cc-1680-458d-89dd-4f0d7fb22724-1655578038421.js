jQuery("#simulation")
              ...
              "actions": [
                {
                  "action": "jimSetValue",
                  "parameter": {
                    "variable": [ "seed_1","seed_3","seed_5","seed_2","seed_6","seed_4" ],
                    "value": {
                      "action": "jimFloor",
                      "parameter": [ {
                        "action": "jimMultiply",
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    ...
                    "datamaster": "Seeds",
                    "fields": {
                      "a3446f8a-5c8e-4205-bfb7-21f46f3960d2": {
                        "datatype": "property",
                        "target": "#s-Input_1",
                        "property": "jimGetValue"
                      },
                      "588ee3e5-f4b1-455f-bb63-32aa326a69e8": {
                        "datatype": "property",
                        "target": "#s-Input_2",
                        "property": "jimGetValue"
                      }
  ...
  .on("mouseenter dragenter", ".s-d12245cc-1680-458d-89dd-4f0d7fb22724 .mouseenter", function(event, data) {
    ...
    if(jFirer.is("#s-Circle") && jFirer.has(event.relatedTarget).length === 0) {
      ...
      cases = [
        {
          "blocks": [
            {
              "condition": (data.variableTarget === "seed_1"),
              "actions": [
                {
                  "action": "jimSetValue",
                  "parameter": {
